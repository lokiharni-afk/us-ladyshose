...
- 排名最高 35 分：前 10 名 35 分、前 30 名 28 分、前 50 名 20 分、其后 10 分。
- 评论数最高 20 分：按 50、300、1000、5000 条评论分档。
- 价格最高 15 分：8-25 美元获得最高分。
- 标题关键词最高 20 分：覆盖 cloud、platform、recovery、orthopedic、comfort、arch support、soft、beach、summer、wedge。
