...
def analyze_reviews(reviews: Iterable[dict[str, Any]]) -> dict[str, dict[str, Any]]:
    ...
    for review in reviews:
        grouped[str(review.get("product_url") or review.get("product_title") or "unknown")].append(dict(review))
    ...
    for key, product_reviews in grouped.items():
        ...
        for review in product_reviews:
            text = f"{review.get('review_title') or ''} {review.get('review_text') or ''}".lower()
        ...
        insights[key] = {
            ...
            "product_url": product_reviews[0].get("product_url") or "",
